...
def show_build_prompt():
    class BuildPrompt(xbmcgui.WindowXMLDialog):
        ...
        def __init__(self, *args, **kwargs):
            ...
            self.msg = "[B]Currently no Build installed!!![/B]\n\n[B]Select[/B] [COLOR dodgerblue][B]'Build Menu'[/B][/COLOR] [B]to view a list of available 709 Builds.[/B]\n\n[B]Select[/B] [COLOR dodgerblue][B]'Ignore'[/B][/COLOR] [B]to never see this message again.[/B]\n\n[B]Enjoy!!![/B]".format(CONFIG.ADDONTITLE, CONFIG.ADDONTITLE)
