...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR gray][B]CBOX[/B][/COLOR]Wizard'
BUILDERNAME = '709'
EXCLUDES = [ADDON_ID, 'repository.cbox', 'plugin.program.cboxwizard]
# Text File with build info in it.
BUILDFILE = 'https://www.dropbox.com/s/nzvh1uhf803m6qk/builds.txt?dl=1'
...
THEME1 = '[COLOR '+COLOR1+'][B]>>>[/B][/COLOR][COLOR ' + COLOR2 + ']>>>[/COLOR] [COLOR '+COLOR2+']{0}[/COLOR]'
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing 709Wizard.'
...
WIZARDFILE = 'https://www.dropbox.com/s/nzvh1uhf803m6qk/builds.txt?dl=1'
#########################################################
...
REPOID = 'repository.CBox'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://raw.githubusercontent.com/Tonkapug/cbox.github.io/master/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/Tonkapug/cbox.github.io/master/zips/repository.709/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR grey][B]709[/B][/COLOR]Wizard'
